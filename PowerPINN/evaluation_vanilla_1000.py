...
def main():
    ...
    with open(metrics_txt, "w") as f:
        f.write("=== Vanilla 1000: TEST LOSS METRICS ===\n")
...
if __name__ == "__main__":
    ...
    plot_true_pred_subplots(y_true, y_pred, t, traj_ids_to_plot, save_path)

    save_single_traj_plot(y_true, y_pred, t, idx=11, save_dir=".")
    # ✅ 清理缓
    # ✅ 清理缓存，防止内存累积导致崩溃
    import gc
