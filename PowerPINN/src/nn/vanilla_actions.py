...
class VanillaNeuralNetworkActions():
    ...
    def define_pinn_model(self):
        ...
        if self.cfg.network.type == "KAN":  # Static architecture of the neural network
            ...
            model = Network(self.input_dim, self.cfg.network.hidden_dim, self.output_dim,
                            self.cfg.network.hidden_layers)
            ...
            model = FullyConnectedResNet(self.input_dim, self.cfg.network.hidden_dim, self.output_dim, num_blocks,
    ...
    def vanilla_train2(self, wandb_run=None):
        """
