...
class DataSampler:
    ...
    def data_input_target_limited(self, data, time_limit):
        ...
        for training_sample in data:
            ...
            y_train = training_sample[1:].T.clone().detach().requires_grad_(True) # target data, get ready for derivative and loss calculation,redundant
            if time_limit != 0:
            ...
            y_train = training_sample_l[1:].T.clone().detach() #requires_grad_(True??)
